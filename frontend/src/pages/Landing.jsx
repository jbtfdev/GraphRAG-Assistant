      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-20">
            <Link
              to="/app"
              className="glow-btn inline-flex items-center justify-center px-8 py-4 rounded-xl bg-linear-to-r from-cyan-500 to-blue-600 text-white font-semibold text-lg hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transition-all"
            >
              Launch Application
